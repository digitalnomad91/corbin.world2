...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>@yield("title", "corbin.world")</title>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left: 5px;">
                                        <div class="col-md-12" style="padding-top: 5px;">
                                            ...
                                            <h3 style="color: #bcbdc2; font-size: 0.7em;"><span id="footer_quote">Synchronicity is the universe's way of <span class="winking">winking</span> at you.</h3>
                                        </div>
                                    </td>
                                </tr>
                            </table>
...
<section style="margin-top: 15px;">
    <article>
        ...
        <p>
            <img width="18" height="18" src="/mirc-icon-19.png" style="position: relative; top: 4px;"> IRC -&gt;&nbsp;<a href="https://subtlefu.ge/irc">#root @ irc.subtlefu.ge</a></script></a>

        </p>
        <p>
            <img width="18" height="18" src="https://element.io/images/favicon.png" style="position: relative; top: 4px;"> Matrix -&gt;&nbsp;<a href="https://matrix.to/#/#root:subtlefu.ge">#root:sublefu.ge</a></script></a>
        </p>
        <p>
            <img width="18" height="18" src="https://github.githubassets.com/favicons/favicon.png" style="position: relative; top: 4px;"> Github -&gt;&nbsp;<a href="https://github.com/digitalnomad91">digitalnomad91</a></script></a>
        </p>
...
<section>
    ...
    <article>
        ...
        <ol id="articles">
            ...
            <li><a href="/crypto">
                <img src="https://static.coincap.io/assets/icons/btc@2x.png" style="max-height: 16px; position: relative; top: 1px;"> Crypto-Currency</a>  - Trade Signals</li>
            <li><a href="https://parkitfor.me" target="_blank">
                <img src="https://kybaproject.com/images/logo.png" style="max-height: 16px; position: relative; top: 2px;"> KYBAProject.com</a>  - Boating Property Theft Database.</li>
            <li><a href="https://kybaproject.com" target="_blank">
                <img src="https://parkitfor.me/assets/img/favicon.ico" style="max-height: 16px; position: relative; top: 2px;"> ParkitFor.Me</a>  - Domain Name Services.</li>
            <li><a href="/resume" target="_blank">
                <img src="/images/favicon.ico" style="max-height: 16px; position: relative; top: 1px;"> Resume</a>  - Curriculum Vitae</li>
        </ol>
    </article>
    <style>
...
<section style="position: relative; top:-30px; display: none;">
    <article>
        <h1 style="margin-bottom:5px;">Media Feeds</h1>
        <p>Memes & Media Steaks:</p>
        <ol id="articles">
            <li><a href="/visual">
                Visual Art</a>  - Cool Art & Other Media.
            </li>
            <li><a href="https://codebuilder.us" target="_blank">
                News</a>  - Current Events & Such.
            </li>
             <li><a href="https://codebuilder.us" target="_blank">
                Music</a>  - Sick Choonz & Reverbs.
            </li>
             <li><a href="https://codebuilder.us" target="_blank">
                Funny</a>  - Funny Memes & Shit.
            </li>
             <li><a href="https://codebuilder.us" target="_blank">
                Science</a>  - Science & Academics.
            </li>
             <li><a href="https://codebuilder.us" target="_blank">
                Technology</a>  - Programming & IT.
            </li>
        </ol>
    </article>
</section>
...
<section style="position: relative; top:-30px;">
    <article>
        ...
        <ol id="articles">
            ...
            <li>
                <a href="https://archive.org/stream/GuerillaOpenAccessManifesto/Goamjuly2008_djvu.txt" target="_blank">Guerilla Open Access Manifesto - Aaron Swartz</a>
            </li>
        </ol>
    </article>
</section>
